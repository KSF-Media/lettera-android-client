...
public class CategoriesApi {
  ...
  */
  public List<Category> categoriesGet (String paper) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * @param paper 
  */
  public void categoriesGet (String paper, final Response.Listener<List<Category>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
